...
import { APP_NAME, APP_TAGLINE, APP_LOGO_PNG } from "@/lib/ui-text";
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center w-full max-w-[320px] z-10 animate-in fade-in zoom-in duration-700">
      <div className="flex flex-col items-center mb-10">
        <div className="w-20 h-20 rounded-3xl overflow-hidden shadow-2xl shadow-primary/30 mb-6 animate-bounce">
          <img src={APP_LOGO_PNG} alt={APP_NAME} className="h-full w-full object-cover" />
        </div>
        <h1 className="text-4xl font-black text-foreground tracking-tighter">
          {APP_NAME}
        </h1>
        <p className="text-foreground/50 text-sm font-medium mt-2 tracking-widest uppercase">
          {APP_TAGLINE}
        </p>
      </div>
